...
(function () {
  ...
  var HINTS = {
    flexbox: {
      'flexbox-width': 'Ширина контейнера (600px, 50%, 80vw). Пусто - контейнер занимает всю доступную ширину.',
    ...
    grid: {
      'grid-width': 'Ширина контейнера (600px, 50%, 80vw). Пусто - контейнер занимает всю доступную ширину; от неё зависят fr-колонки и auto-fill/auto-fit.',
